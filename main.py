...
if __name__ == '__main__':
    ...
    parser.add_argument('--celeba_image_dir', type=str, default='D:/pythonWorkplace/Dataset/CelebA_nocrop/images')
    parser.add_argument('--attr_path', type=str, default='data/list_attr_celeba.txt')
    parser.add_argument('--rafd_image_dir', type=str, default='data/RaFD/train')
    parser.add_argument('--raf_image_dir', type=str, default='D:/pythonWorkplace/StarGAN-master/data/style_photo/train')
